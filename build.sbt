...
lazy val hello = (project in file("."))
  .settings(
    ...
    libraryDependencies += "giuliohome.com" % "kyo-chatgpt_3" % "0.0.0+270-ba2abf72+20230408-0229-SNAPSHOT", // "0.0.0+269-abf82b89+20230407-1230-SNAPSHOT",  // "0.0.0+266-77c10268+20230405-1250-SNAPSHOT",
